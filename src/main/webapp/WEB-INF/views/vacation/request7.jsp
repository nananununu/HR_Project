         ...
         <div class="card-body">
            ...
            <input type="hidden" id="employee_id" name="employee_id" value="${employee_id }" class="form-control" readonly="readonly" style="background: #D1D1D1;" required>
               ...
               <div class="mb-3">
                  ...
                  <input type="text" id="vacation_name" name="vacation_name" value="긴급" class="form-control" readonly="readonly" style="background: #D1D1D1;" required>
               </div>
               <div class="mb-3">
      ...
      $(document).ready(
            function() {
               ...
               function updateVacationDays() {
                  var startDate = new Date($("#vacation_start_date")
                        .val());
                  var endDate = new Date($("#vacation_end_date").val());
                  var timeDiff = (Math.round((endDate - startDate)
                        / (1000 * 60 * 60 * 24))) + 1;
               ...
               function disableWeekends() {
                  ...
                  while (currentDay <= endDate) {
                     if (currentDay.getDay() === 0
                           || currentDay.getDay() === 6) {
                        alert('날짜를 확인해 주세요');
                        $("#vacation_end_date").val(startDate);
                        updateVacationDays();
                        return;
                     }
